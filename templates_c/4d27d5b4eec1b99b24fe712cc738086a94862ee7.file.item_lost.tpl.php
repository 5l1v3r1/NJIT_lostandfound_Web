<?php /* Smarty version Smarty-3.0.6, created on 2017-04-06 06:55:21
         compiled from ".\templates\item_lost.tpl" */ ?>
<?php /*%%SmartyHeaderCode:754558e648c91c14d3-51513343%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4d27d5b4eec1b99b24fe712cc738086a94862ee7' => 
    array (
      0 => '.\\templates\\item_lost.tpl',
      1 => 1490457177,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '754558e648c91c14d3-51513343',
  'function' => 
  array (
  ),
...
<?php $_template = new Smarty_Internal_Template("config.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
	<title>寻物启事><?php echo (($tmp = @$_smarty_tpl->getVariable('item')->value['what'])===null||$tmp==='' ? "物品信息不存在" : $tmp);?>
</title>
...
"]);
		<?php  $_smarty_tpl->tpl_vars['found'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('founds')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['found']->key => $_smarty_tpl->tpl_vars['found']->value){
?>mapdatas.push(["<?php echo $_smarty_tpl->tpl_vars['found']->value['mapdata'];?>
",<?php echo $_smarty_tpl->tpl_vars['found']->value['id'];?>
,"<?php echo $_smarty_tpl->tpl_vars['found']->value['what'];?>
"]);<?php }} ?>
	</script>
...
</td><td rowspan="5" class="imageCol"><img src="<?php echo (($tmp = @$_smarty_tpl->getVariable('item')->value['imageurl'])===null||$tmp==='' ? "images/noitem.png" : $tmp);?>
" id="image" class="image-fixed"></img></td></tr>
						<tr><th>丢失日期</th><td><?php echo smarty_modifier_date_format($_smarty_tpl->getVariable('item')->value['when'],"%Y-%m-%d");?>
</td></tr>
						<tr><th>丢失地点</th><td><?php if ($_smarty_tpl->getVariable('item')->value['where']!="#"){?><a href="search.php?where=<?php echo $_smarty_tpl->getVariable('item')->value['where'];?>
...
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['found']->key => $_smarty_tpl->tpl_vars['found']->value){
?>
						<li><a href="found.php?id=<?php echo $_smarty_tpl->tpl_vars['found']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['found']->value['what'];?>
</a></li>
					<?php }} else { ?>
						<li>没有相关招领启事</li>
