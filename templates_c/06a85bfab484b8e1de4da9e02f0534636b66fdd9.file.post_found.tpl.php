<?php /* Smarty version Smarty-3.0.6, created on 2017-04-06 06:59:35
         compiled from ".\templates\post_found.tpl" */ ?>
<?php /*%%SmartyHeaderCode:684658e649c7294480-22636549%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '06a85bfab484b8e1de4da9e02f0534636b66fdd9' => 
    array (
      0 => '.\\templates\\post_found.tpl',
      1 => 1491487122,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '684658e649c7294480-22636549',
  'function' => 
  array (
  ),
...
<?php $_template = new Smarty_Internal_Template("config.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
	...
	<script type="text/javascript" src="js/post_found.js"></script>
</head>
<body>
	...
	<div id="main">
		<div class="container">
			...
			<div class="contentLeft">
				...
				<form action="?type=found&action=post" id="postform" method="post" enctype="multipart/form-data">
					<div id="accordion">
...
"/>
								...
								<tr><th></th>
									<td>
										...
										<p class="tip">[可选]在地图上标出您拾到物品的地点</p>
